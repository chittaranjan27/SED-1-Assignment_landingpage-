...
export function FeatureSection({
  ...
  return (
    <section id={feature.id} className={cn("py-12 sm:py-16 lg:py-20", reversed && "bg-white")}>
      <Container
        className={cn(
      ...
      >
        <div className={cn("justify-self-center", reversed && "lg:order-2")}>
          <Image src={feature.image} alt={feature.imageAlt} width={440} height={420} />
        </div>
        <div className={cn("max-w-[660px]", reversed && "lg:order-1")}>
